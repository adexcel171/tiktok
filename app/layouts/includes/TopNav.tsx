...
export default function TopNav() {
  ...
  return (
    <>
      <div
        id="TopNav"
        className="fixed bg-white z-30 flex items-center w-full border-b h-[70px]"
      >
        <div
          className={`flex items-center justify-between gap-6 w-full  mx-auto ${
            pathname === "/" ? "max-w-[1150px]" : ""
          }`}
        >
          <Link href="/">
            <img className="min-w-[80px] w-[80px]" src="/images/1.png" />
          </Link>
