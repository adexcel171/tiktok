...
import { useUser } from "@/app/hooks/context/user"
            ...
            >
                ...
                <div className="lg:w-full w-[55px] mx-auto flex flex-col lg:flex-row items-start lg:items-end">
                    ...
                    <div className="lg:block hidden text-[11px] text-gray-500">
                        <p className="pt-4 px-2">About Newsroom excel Shop Contact Careers ByteDance</p>
                        <p className="pt-4 px-2">for Good Advertise Developers Transparency  Rewards</p>
                        <p className="pt-4 px-2">Help Safety Terms Privacy Creator Portal Community Guidelines</p>
                        <p className="pt-4 px-2">© 2024 excel-tech</p>
                    </div>
